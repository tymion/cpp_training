...
cmake ../ -DCMAKE_BUILD_TYPE=Debug -DCROSS_COMPILE=$CROSS_COMPILE -DCROSS_COMPILE_PATH=$CROSS_COMPILE_PATH -DCMAKE_TOOLCHAIN_FILE=$TOOLCHAIN_FILE -DROOTFS=$DESTDIR_TARGET -DROOTFS_HOST=$DESTDIR_HOST -DHOST=$HOST -DPYTHONPATH=$PYTHONPATH
make
...
echo "LD_LIBRARY_PATH=$DESTDIR_TARGET/lib:$DESTDIR_TARGET/usr/local/lib QEMU_LD_PREFIX=$CROSS_COMPILE_PATH/$HOST/libc/"
