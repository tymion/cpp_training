...
cmake ../ -DCROSS_COMPILE=$CROSS_COMPILE -DCROSS_COMPILE_PATH=$CROSS_COMPILE_PATH -DCMAKE_TOOLCHAIN_FILE=$TOOLCHAIN_FILE -DROOTFS=$DESTDIR_TARGET -DROOTFS_HOST=$DESTDIR_HOST -DHOST=$HOST -DPYTHONPATH=$PYTHONPATH
make
